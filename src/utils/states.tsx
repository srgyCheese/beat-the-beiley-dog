export const beileyStates = {
  ...
  feeding: {
    openMouth: '/assets/beiley-feeding/openMouth.jpg',
    closedMouth: '/assets/beiley-feeding/closedMouth.jpg',
    happy: '/assets/beiley-feeding/happy.jpg',
    uncanny: '/assets/beiley-feeding/uncanny.jpg'
  }
}